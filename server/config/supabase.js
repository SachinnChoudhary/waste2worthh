  ...
  profiles: [
    {
      ...
      clerk_user_id: 'user_northgate_01',
      email: 'procurement@northgatesteel.demo',
      full_name: 'Rajesh Sharma',
      company_name: 'Northgate Steelworks Ltd.',
      role: 'seller',
    ...
    },
    {
      ...
      clerk_user_id: 'user_meridian_02',
      email: 'circular@meridianchem.demo',
      full_name: 'Ananya Mehta',
      company_name: 'Meridian Petrochemicals',
      role: 'seller',
      gstin: '24BBBBB0000B1Z2',
      phone: '+91 265 555 0102',
      city: 'Vadodara',
      state: 'Gujarat',
      verified: true,
      credit_score: 920,
    ...
    },
    {
      ...
      clerk_user_id: 'user_apex_05',
      email: 'sourcing@apexmaterials.demo',
      full_name: 'Karan Verma',
      company_name: 'Apex Matrix Materials Ltd.',
      role: 'buyer',
      gstin: '27CCCCC0000C1Z3',
  ...
  bids: [
    {
      ...
      buyer_company: 'Apex Matrix Materials Ltd.',
